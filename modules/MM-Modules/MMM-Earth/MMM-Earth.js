...
Module.register("MMM-Earth", {
    ...
    getDom: function() {
        ...
        if (!this.loaded) {
            //wrapper.innerHTML = "Hello, Mother Earth...<img src='modules/MM-Modules/MMM-EARTH/loading/loading.gif' width='22' height='22'>";
            wrapper.innerHTML = "Hello, the Earth is loading...";
