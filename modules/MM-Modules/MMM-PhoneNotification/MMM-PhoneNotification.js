...
Module.register("MMM-PhoneNotification", {
  defaults: {
    accessToken: '',
  ...
  getStyles: function() {
    return ["MMM-PhoneNotification.css", "font-awesome.css"];
  },
    ...
    if (this.payload.length > 0) {
      ...
      this.payload.slice(0, this.config.numberOfNotifications).forEach(function(o) {
        ...
        if (that.config.displayNotificationIcon) {
          ...
          var iconPath = '/modules/MM-Modules/MMM-PhoneNotification/icons/' + o.application_name + '.jpg';
        ...
        if (that.config.displayMessage) {
          ...
          bodyContentWrapper.style.fontFamily = "Microsoft Yahei";
